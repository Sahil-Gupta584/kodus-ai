...
export class AddPendingEmailStatus1759002102875 implements MigrationInterface {
    name = 'AddPendingEmailStatus1759002102875'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TYPE "public"."teams_status_enum_old" AS ENUM(
                'active',
                'inactive',
                'pending',
                'awaiting_approval',
        ...
        await queryRunner.query(`
            CREATE TYPE "public"."users_status_enum_old" AS ENUM(
                'active',
                'inactive',
                'pending',
                'awaiting_approval',
