...
export function getLLMModelProviderWithFallback(
    ...
    const envKeyMap: Record<LLMModelProvider, string> = {
        ...
        [LLMModelProvider.CHATGPT_3_5_TURBO_16K]:
            'API_LLM_MODEL_CHATGPT_3_5_TURBO_16K',
        ...
        [LLMModelProvider.CHATGPT_4_ALL_MINI]:
            'API_LLM_MODEL_CHATGPT_4_ALL_MINI',
        ...
        [LLMModelProvider.GEMINI_1_5_PRO_EXP]:
            'API_LLM_MODEL_GEMINI_1_5_PRO_EXP',
        ...
        [LLMModelProvider.GEMINI_2_5_PRO_PREVIEW]:
            'LLM_MODEL_GEMINI_2_5_PRO_PREVIEW',
        [LLMModelProvider.GEMINI_2_5_PRO_PREVIEW_05_06]:
            'LLM_MODEL_GEMINI_2_5_PRO_PREVIEW_05_06',
